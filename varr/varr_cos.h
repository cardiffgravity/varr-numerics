...
#ifndef __VARR_COS_H__
#define __VARR_COS_H__

#include <stddef.h>

/*
 * An object that provides a VARR implementation of the real cosine function.
 * 
 * This implementation provides a scalar cosine function, 'cosd', a function 
 * accepting one real number, x, and returning a VARR approximation of cos(x)
 */
typedef struct tagVARRCosDEvaluator {
   void const * accelerator;
   
   /*
    * A VARR real cosine function.  The first argument to this method is 
    * the number, x, for which cos(x) is to be evaluated and returned.
    */
   double (* cosd) (double, void const * accelerator);
   
   int (* disallocate) (struct tagVARRCosDEvaluator *);
} VARRCosDEvaluator;

/*
 * Returns an object that provides a VARR implementation of the real 
 * cosine function.   See documentation for the type VARRCosDEvaluator
 * for further information.
 * 
 * This function allocates a sampling grid of cosine values.  The size of
 ...
 * numerical accuracy of the cosine function that is generated by this
 ...
 * for further information.
 * 
 * This method uses cubic spline techniques to compute the cosine.  Memory is
 ...
 * The numerical accuracy of the cosine function that is generated by this
 * method generally increases with the number of sampling points requested.
 *
 * This function does not return meaningful values if the input, x, is not 
